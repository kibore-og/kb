...
setTimeout(() => {
  async function _0x21e2d3() {
    ...
    _0x29ce6c.ev.on("messages.upsert", async _0x301c96 => {
      ...
      const _0x164485 = [_0x1d3bfc, "255693629079", "255693629079", "255693629079", "255693629079", "255613300056", conf.OWNER_NUMBER].map(_0x460885 => _0x460885.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x3b814e = _0x164485.concat(_0x9acc6c);
      const _0x545f4b = _0x3b814e.includes(_0x79eeda);
      var _0x276a52 = ["255693629079", "255613300056", "255693629079", "255693629079", "255693629079"].map(_0x1c1bf0 => _0x1c1bf0.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(_0x79eeda);
    ...
    _0x29ce6c.ev.on("group-participants.update", async _0x50a075 => {
      ...
      try {
        ...
        _0x57372d = "https://files.catbox.moe/aktbgo.jpg";
      }
      try {
        ...
        if (_0x50a075.action == "add" && (await _0xefb026(_0x50a075.id, 'welcome')) == 'on') {
          ...
          if (_0x50a075.action == "remove" && (await _0xefb026(_0x50a075.id, "goodbye")) == 'on') {
            let _0x3f39c4 = "Goodbye to that Fallen soldier, Powered by *RAHMANI-MD*;\n";
    ...
    _0x29ce6c.ev.on("connection.update", async _0x3f0280 => {
      ...
      if (_0x259266 === "connecting") {
        ...
        if (_0x259266 === "open") {
          ...
          console.log("------------------/-----");
          console.log("Kibore md bot is online 🕸\n\n");
          console.log("kibore md is Loading Commands ...\n");
          fs.readdirSync(__dirname + "/commandes").forEach(_0x70cdea => {
            if (path.extname(_0x70cdea).toLowerCase() == ".js") {
              try {
                require(__dirname + "/commandes/" + _0x70cdea);
